...
<body>
<?php
$vt=new mysqli("localhost:3306", "ieveserh", "lcQw6pJN", "ieveserh_eser") or die ("Bağlanamadı");
$vt->set_charset("utf8")
?>
...
public function resimyon ($vt) {
    ...
    $so=$this->sorgum3($vt, "select * from resim LIMIT ".$this->limitimiz.",".$this->gosAdet."");
        echo'
        <div class="col-md-16 text-center mx-auto mt-5 table-bordered row text-center">

<div class="col-lg-12"><a href="ayarlar.php?islem=resimekle" class="btn btn-success text-light">YENİ RESİM EKLE</a></div>';
...
<div class="alert col-md-16 text-center mx-auto mt-5 table-bordered row text-center">
 Küpe No → '.$sonbilgi["kupeno"].'
</div>
...
<?php
$baglanti=mysqli_connect("localhost:3306", "ieveserh", "lcQw6pJN", "ieveserh_eser");
